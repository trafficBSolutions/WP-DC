...
const mySearch = new _modules_Search__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(dcData.root_url + "/wp-json/dc/v1/search?term=" + this.searchField.value);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkdirect_connecting"] = globalThis["webpackChunkdirect_connecting"] || [];
